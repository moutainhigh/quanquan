...
public class User extends BaseLog<User> implements Serializable {
    ...
    /**固定分组**/
    private List<String> staicGroupId;

    /**拉人分组***/
    private List<String> larenGroupId;
    ...
    public List<String> getStaicGroupId() {
		return staicGroupId;
	}

	public void setStaicGroupId(List<String> staicGroupId) {
		this.staicGroupId = staicGroupId;
	}

	public List<String> getLarenGroupId() {
		return larenGroupId;
	}

	public void setLarenGroupId(List<String> larenGroupId) {
