...
public class SensitivewordFilter {
	...
	public static void init(String file_path){
		filter = new SensitivewordFilter(file_path);
	}
	 ...
	 * 构造函数，初始化敏感词库
	 */
	private SensitivewordFilter(String file_path){
		sensitiveWordMap = new SensitiveWordInit().initKeyWord(file_path);
	}
...
//		SensitivewordFilter.init("config/words.dlt");
//		System.out.println("敏感词的数量：" + filter.sensitiveWordMap.size());
//		String string = "阴道的伤感情怀也许只局限于饲养基地 荧幕中的情节，主人公尝试着去用某种方式渐渐的很潇洒地释自杀指南怀那些自己经历的伤感。"
