...
public class Demo {
	...
	public void sendAndroidUnicast() throws Exception {
		...
		unicast.setPredefinedKeyValue("device_tokens", "AqBTjsS_J6g9gLKu8KCpuucoq4iryEvUoIKfRJAN6gjG");
		unicast.setPredefinedKeyValue("ticker", "Android unicast ticker");
		unicast.setPredefinedKeyValue("title", "中文的title");
		unicast.setPredefinedKeyValue("text", "就是测试");
		unicast.setPredefinedKeyValue("after_open", "go_app");
		unicast.setPredefinedKeyValue("alias_type", "alias");
		unicast.setPredefinedKeyValue("alias", "alias");
		unicast.setPredefinedKeyValue("custom", "测试内容没有理由");
	...
	public void sendAndroidUnicast2() throws Exception {
		...
		unicast.setPredefinedKeyValue("custom", "测试内容没有理由1");
		//unicast.setPredefinedKeyValue("display_type", "notification");
		unicast.setPredefinedKeyValue("display_type", "message");
		// TODO Set 'production_mode' to 'false' if it's a test device.
		// For how to register a test device, please see the developer doc.
	...
	public void sendAndroidCustomizedcast() throws Exception {
		...
		customizedcast.setPredefinedKeyValue("alias", "AqBTjsS_J6g9gLKu8KCpuucoq4iryEvUoIKfRJAN6gjG");
		customizedcast.setPredefinedKeyValue("device_tokens", "AqBTjsS_J6g9gLKu8KCpuucoq4iryEvUoIKfRJAN6gjG");
		// TODO Set your alias_type here
		customizedcast.setPredefinedKeyValue("alias_type", "AqBTjsS_J6g9gLKu8KCpuucoq4iryEvUoIKfRJAN6gjG");
		customizedcast.setPredefinedKeyValue("ticker",
				"Android customizedcast ticker");
		customizedcast.setPredefinedKeyValue("title", "透传测试");
	...
	public static void main(String[] args) {
		// TODO set your appkey and master secret here  AqBTjsS_J6g9gLKu8KCpuucoq4iryEvUoIKfRJAN6gjG
		Demo demo = new Demo("5583745067e58e85f5002afa", "qstgu9fyl5c5ex1wqwnrvswp8kkt5s8u");
		try {
