...
server_home_sh="${server_home}/deal_deah_question.sh"
# -XX:+UseG1GC
...
cd ${server_home}
if [ $# -eq 2 ];then
    java -cp ${server_class_path} com.circle.wena.task.dead.TaskClearDeahQuestion $1 $2
elif [ $# -eq 3 ] ;then
    java -cp ${server_class_path} com.circle.wena.task.dead.TaskClearDeahQuestion $1 $2 $3
elif [ $# -eq 1 ] ;then
    java -cp ${server_class_path} com.circle.wena.task.dead.TaskClearDeahQuestion $1
fi