 ...
 * @ Deprecated using @see {@link Redis}
 * @author clicoy
 *
 */
...
public class RedisUtil {
    ...
    public static ShradRedisClient SHARD_POOL;
    ...
    public static void initialShard(Config conf) {
        ...
        String[] redis_nodes = conf.getAsString("redis.nodes").split(",");
        int MaxTotal = conf.getAsInteger("redis_pool_MaxTotal");
        int MaxIdle = conf.getAsInteger("redis_pool_MaxIdle");
        int MinIdle = conf.getAsInteger("redis_pool_MinIdle");
        ...
        SHARD_POOL = new ShradRedisClient(config, shards);
    }
