...
/**
 * 项目名称：qietu
 * 类名称：SendSMSWebService
 * 类描述：
 * 创建人：lcm
 * 创建时间：2015年3月10日 下午1:37:20
 * @version
 */
...
public class SendSMS {
	 ...
	 * 构造函数
	 */
	public SendSMS(String sn, String password)
	...
	/*
	 * 方法名称：mdSmsSend_u 功 能：发送短信 ,传多个手机号就是群发，一个手机号就是单条提交 参
	 * 数：mobile,content,ext,stime,rrid(手机号，URL_UT8编码内容，扩展码，定时时间，唯一标识) 返 回
	 * 值：唯一标识，如果不填写rrid将返回系统生成的
	 */
	 ...
	 * @return
	 */
	public static String sendPhoneSms(String messageContent, String userPhone) {
		// 输入软件序列号和密码
		String sn = "SDK-BBX-010-21086";
		String pwd = "096366";
		// String mobiles="18630812458";
		String content;
		try {
			content = URLEncoder.encode(messageContent + "【吃喝玩乐网】", "utf8");
			SendSMS client = new SendSMS(sn, pwd);
			String result_mt = client.mdSmsSend_u(userPhone, content, "", "",
					"");
